...
| 4.3.0 | 2026-03-19 | Reliability: no silent truncation, subtask state persistence, local-context overflow fix. |
| 4.2.0 | 2026-03-16 | Cross-platform: Windows-safe locking, reconnect recovery. |
| 4.1.0 | 2026-03-16 | Public desktop release with Web UI and dual-layer safety. |
